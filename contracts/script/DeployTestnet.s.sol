...
contract DeployTestnet is Script {
    ...
    function run() external {
        ...
        console.log("==========================================");
        console.log("Deploy NAIO contracts to BSC Testnet");
        console.log("==========================================");
        console.log("USDT_TOKEN:", usdtToken);

        console.log("\n1. Deploy NAIOToken...");
        NAIOToken aio = new NAIOToken(
            "NAIO",
            "NAIO",
            INITIAL_SUPPLY,
            BURN_ADDR,
        ...
        console.log("   OK: transferred", REFERRAL_BOOTSTRAP_NAIO / 1e18, "NAIO to bootstrap address");
        console.log("   OK: transferred", (INITIAL_SUPPLY - REFERRAL_BOOTSTRAP_NAIO) / 1e18, "NAIO to Controller");
